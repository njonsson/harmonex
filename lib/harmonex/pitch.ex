defmodule Harmonex.Pitch do
  ...
  defstruct bare_name: nil, accidental: :natural

  @type t :: %{bare_name: bare_name, accidental: accidental} |
             %{bare_name: bare_name}                         |
             atom
  ...
  ## Examples
      ...
      iex> Harmonex.Pitch.adjust_by_semitones %{bare_name: :a, accidental: :sharp}, 14
      %Harmonex.Pitch{bare_name: :c, accidental: :natural}
  ...
  ## Examples
      ...
      iex> Harmonex.Pitch.accidental %{bare_name: :a, accidental: :flat}
      :flat

      iex> Harmonex.Pitch.accidental %{bare_name: :a}
      :natural
  ...
  for bare_name <- @bare_names, accidental <- @accidentals do
    full_name = String.to_atom("#{to_string bare_name}_#{to_string accidental}")
    def accidental(unquote(full_name)=_pitch), do: unquote(accidental)
  end

  for bare_name <- @bare_names do
    def accidental(%{bare_name: unquote(bare_name)}=_pitch), do: :natural

    def accidental(unquote(bare_name)=_pitch), do: :natural
  end
  ...
  ## Examples
      ...
      iex> Harmonex.Pitch.bare_name %{bare_name: :a, accidental: :flat}
      :a
  ...
  ## Examples
      ...
      iex> Harmonex.Pitch.enharmonic? %{bare_name: :g, accidental: :sharp}, :a_flat
      true

      iex> Harmonex.Pitch.enharmonic? :c_flat, %{bare_name: :a, accidental: :double_sharp}
      true
  ...
  ## Examples
      ...
      iex> Harmonex.Pitch.enharmonics %{bare_name: :g, accidental: :sharp}
      [%Harmonex.Pitch{bare_name: :a, accidental: :flat}]
  ...
  ## Examples
      ...
      iex> Harmonex.Pitch.full_name %{bare_name: :a, accidental: :flat}
      :a_flat
  ...
  for bare_name <- @bare_names do
    def full_name(%{bare_name: unquote(bare_name), accidental: _}=_pitch) do
  ...
  ## Examples
      ...
      iex> Harmonex.Pitch.interval %{bare_name: :a, accidental: :sharp}, %{bare_name: :c}
  ...
  ## Examples
      ...
      iex> Harmonex.Pitch.new %{bare_name: :a, accidental: :flat}
      %Harmonex.Pitch{bare_name: :a, accidental: :flat}

      iex> Harmonex.Pitch.new %{bare_name: :a}
      %Harmonex.Pitch{bare_name: :a, accidental: :natural}
  ...
  for bare_name <- @bare_names, accidental <- @accidentals do
    ...
    ## Examples
        ...
        {:error, #{inspect @invalid_accidental}}
    """
    def new(unquote(bare_name)=bare_name, unquote(accidental)=accidental) do
      __MODULE__ |> struct(bare_name: bare_name, accidental: accidental)
    end

    full_name = :"#{to_string bare_name}_#{to_string accidental}"
    def new(unquote(full_name)=_name) do
      new unquote(bare_name), unquote(accidental)
    end
  end
  ...
  for bare_name <- @bare_names do
    ...
    def new(%{bare_name: unquote(bare_name), accidental: _}=_name) do
      {:error, @invalid_accidental}
    end
    ...
    def new(unquote(bare_name)=_bare_name, _invalid_accidental) do
      {:error, @invalid_accidental}
    end
  end
  ...
  ## Examples
      ...
      iex> Harmonex.Pitch.semitones %{bare_name: :a, accidental: :flat}, %{bare_name: :c, accidental: :sharp}
      5
